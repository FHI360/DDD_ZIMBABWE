...
import { Patient, DevolveService } from '../devolve.service';
...
@Component({
    ...
    templateUrl: './devovle.component.html',
    styleUrls: ['./devovle.component.scss'],
...
export class DevovleComponent implements OnInit, OnDestroy {
    ...
    constructor(private _activatedRoute: ActivatedRoute,
                ...
                private _devolveService: DevolveService,
    ...
    siteChanged(patient: Patient, site?: OrgUnit) {
        if (site) {
            this._devolveService.assignPatient(site.id, patient.id).subscribe(_=> this.listPatients());
        } else {
            this._devolveService.unassignPatient(patient.id).subscribe(_=> this.listPatients());
        }
