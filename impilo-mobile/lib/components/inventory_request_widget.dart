...
class InventoryRequestWidget extends StatefulWidget {
  ...
  @override
  _InventoryRequestWidgetState createState() => _InventoryRequestWidgetState();
}

class _InventoryRequestWidgetState extends State<InventoryRequestWidget> {
  late InventoryRequestModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InventoryRequestModel());
