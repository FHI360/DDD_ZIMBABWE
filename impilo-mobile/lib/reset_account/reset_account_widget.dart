...
import 'reset_account_model.dart';
export 'reset_account_model.dart';

class ResetAccountWidget extends StatefulWidget {
  const ResetAccountWidget({Key? key}) : super(key: key);
...
class _ResetAccountWidgetState extends State<ResetAccountWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ResetAccountModel());
