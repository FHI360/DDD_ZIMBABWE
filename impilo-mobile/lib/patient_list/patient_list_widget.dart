...
class _PatientListWidgetState extends State<PatientListWidget> {
  ...
  Future<List<Patient>> getPatients() async {
    ...
    return _database.patientDao.findAll(FFAppState().code);
  }
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: FlutterFlowIconButton(
                          ...
                          onPressed: () async {
                            _model.patients = await actions.filterPatients(
                  ...
                  Padding(
                    ...
                    child: FutureBuilder<List<Patient>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<Patient> listViewPatientRowList = snapshot.data!;
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        listViewPatientRow.givenName
                                                .substring(0, 1)
                                                .toUpperCase() +
                                            listViewPatientRow.familyName
                                                .substring(0, 1)
                                                .toUpperCase(),
                                      ...
                                      Expanded(
                                        child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                '${listViewPatientRow.givenName} ${listViewPatientRow.familyName}',
                                                style:
                      ...
                      builder: (context) {
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, patientListIndex) {
                            final patientListItem =
                                patientList[patientListIndex];
                            return Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  16.0, 4.0, 16.0, 8.0),
                              child: Container(
